...
app.get('/', async (req, res) => {
  ...
  const msg = `${deletions} used shared wheels deleted`;
  console.log(msg);
  res.json({status: msg});
});
...
async function getUsedSharedWheels(db, cutoffDate) {
  console.log(`Getting used shared wheels last read before "${cutoffDate}"`);
